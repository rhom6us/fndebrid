...
)<Payload<[TorrentId, FileId[]]>, undefined, Error>();
...
export const fetchAllTorrents = createAsyncAction(
  'real-debrid/fetch-all/request',
  'real-debrid/fetch-all/success',
  'real-debrid/fetch-all/error',
)<undefined, Torrent[], Error>();

export const fetchActiveTorrents = createAsyncAction(
  'real-debrid/fetch-active/request',
  'real-debrid/fetch-active/success',
  'real-debrid/fetch-active/error',
)<undefined, Torrent[], Error>();
...
)<Payload<[MagnetLink, JobId]>, Payload<[TorrentId, JobId]>, Error>();
...
)<Payload<[string, JobId]>, Payload<[TorrentId, JobId]>, Error>();
...
)<Payload<[TorrentHash, JobId]>, Payload<[FileId[][], JobId]>, Error>();
