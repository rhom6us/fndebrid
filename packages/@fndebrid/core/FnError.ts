...
export class ArgumentNullOrUndefinedError extends ArgumentFalsyError {
  constructor(
    public readonly name: string,
    message: string = `The value passed for "${name}" was null or undefined.`,
  ) {
    super(name, message);
  }
}
export class ArgumentUndefinedError extends ArgumentNullOrUndefinedError {
  constructor(
    public readonly name: string,
    message: string = `The value passed for "${name}" was undefined.`,
  ) {
    super(name, message);
  }
}
...
export class ArgumentNullError extends ArgumentNullOrUndefinedError {
  constructor(
    public readonly name: string,
    message: string = `The value passed for "${name}" was null.`,
  ) {
    super(name, message);
  }
}
...
export class InvalidArgumentError extends ArgumentError {
  constructor(
    public readonly name: string,
    message: string = `The value passed for ${name} was not valid.`,
    innerError?: any,
  ) {
