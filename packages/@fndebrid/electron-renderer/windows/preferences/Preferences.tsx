...
export const Preferences: React.FC = () => {
  const {
    downloadLocation,
    magnetLinksAssociated,
    torrentFilesAssociated,
    autoDownloadTorrents,
    autoDeleteTorrentFile,
    autoDeleteServer,
    fileWhiteList,
    fileBlackList,
  } = useEventSource(state => state.preferences);
  const {
    chooseDownloadLocation,
    setAutoDownloadTorrents,
    setAutoDeleteServer,
    associateMagnetLinks,
    associateTorrentFiles,
    setAutoDeleteTorrentFile,
    setWhiteList,
    setBlackList,
  } = useCommand(
    ({
      preferences: { chooseDownloadLocation, updatePreferences, associateTorrentFiles, associateMagnetLinks },
    }) => ({
      chooseDownloadLocation: (downloadLocation: string = app.getPath('downloads')) =>
        updatePreferences({ downloadLocation }),
      ...
      setAutoDeleteTorrentFile: (autoDeleteTorrentFile: AutoDeleteTorrentFileOption) =>
        updatePreferences({ autoDeleteTorrentFile }),
      ...
      <Callout title="Files">
        ...
        {autoDeleteTorrentFile !== 'never' && (
          ...
          >
            ...
            <Radio
              label="...after the torrent download is complete on real-debrid"
              value="torrent_completed"
            />
