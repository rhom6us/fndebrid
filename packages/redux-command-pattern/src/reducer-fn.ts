...
export type InferState<T extends DeepDictionaryItem<ReducerFn<any, any>>> = T extends DeepDictionaryItem<
  ReducerFn<infer TState, any>
>
  ? TState
  : { ERROR: { T: T } };

export type InferPayload<TMap extends DeepRecordItem<string, ReducerFnAny>> = TMap extends Func<
  [any, ...infer TPayload],
  any
>
  ? TPayload
